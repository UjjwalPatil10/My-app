...
const GalleryContent = () => {
  ...
  const filterItem = (categItem) => {
    const updatedItems = Menu.filter((curEle, ind, arr) => {
      ...
      <div className="menu-tabs container ">
        <div className="menu-tab d-flex justify-content-around ">
          <button
            ...
            onClick={() => filterItem("breakfast")} // in {} we make function call because js only work in object i.e why we take like this {() => filterItem("breakfast")}
          >
            Laptop
          </button>
          <button
