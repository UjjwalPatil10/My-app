...
const UserProfile = ({
  ...
  // const { name, gender, mobile, email, age, address, avatar, id } = this.props;
  return (
    <>
      <div
        style={{
  ...
  return (
    <>
      <div>
        ...
        <hr />
        Gender:
        <button style={margin} onClick={() => handleGender("male")}>
          Male
        </button>
        <button style={margin} onClick={() => handleGender("female")}>
          Female
        </button>
        <button style={margin} onClick={() => handleGender("all")}>
          All
        </button>
        City:
        <button style={margin} onClick={() => handleCity("pune")}>
          Pune
        </button>
        <button style={margin} onClick={() => handleCity("mumbai")}>
          Mumbai
        </button>
        <button style={margin} onClick={() => handleCity("nashik")}>
          Nashik
        </button>
        <button style={margin} onClick={() => handleCity("all")}>
          All
        </button>
